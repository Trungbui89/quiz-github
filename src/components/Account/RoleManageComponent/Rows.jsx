...
export default function Rows(props) {
    const {postAddPerToRole, roleDetail} = props
    const [addPerToRole, setAddPerToRole] = React.useState();

    useEffect(()=> {
        if(addPerToRole){
            postAddPerToRole(addPerToRole)
        }
    }, [addPerToRole])
